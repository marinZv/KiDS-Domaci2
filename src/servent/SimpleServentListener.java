...
import servent.handler.snapshot.LiMarkerHandler;
import servent.handler.snapshot.LiTellHandler;
...
//						//Treba proveriti da li treba ovde continue
//						continue;
//					}else{
//						LiBitcakeManager liBitcakeManager = (LiBitcakeManager)snapshotCollector.getBitcakeManager();
//						LiMarkerMessage liMarkerMessage =  (LiMarkerMessage)clientMessage;
//						liBitcakeManager.markerEvent(liMarkerMessage.getSnapshotVersion(), snapshotCollector);
//					}

//					LiBitcakeManager liBitcakeManager = (LiBitcakeManager) snapshotCollector.getBitcakeManager();
//					liBitcakeManager.markerEvent(clientMessage.getMessageText(), snapshotCollector);
				...
				case LI_MARKER:
					...
					break;
				case LI_TELL:
					AppConfig.timestampedStandardPrint("Dobio sam tell, treba da obradim tell poruku, snapshot_no: " + AppConfig.getFixedSnapshotVersion());
